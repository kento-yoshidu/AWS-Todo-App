...
type ContentfulBlogPostFilterInput = {
  ...
  readonly content: Maybe<ContentfulBlogPostContentFilterInput>;
...
type ContentfulBlogPostFieldsEnum =
  ...
  | 'category.blogpost.content.raw'
  | 'category.blogpost.content.references'
  ...
  | 'category.blogpost.category.categorySlug'
...
type ContentfulCategoryFieldsEnum =
  ...
  | 'blogpost.content.references.contentful_id'
  | 'blogpost.content.references.id'
  | 'blogpost.content.references.spaceId'
  | 'blogpost.content.references.createdAt'
  | 'blogpost.content.references.updatedAt'
  | 'blogpost.content.references.title'
  | 'blogpost.content.references.description'
  | 'blogpost.content.references.node_locale'
  | 'blogpost.content.references.gatsbyImageData'
  | 'blogpost.content.references.children'
  ...
  | 'blogpost.category.categorySlug'
...
type Unnamed_1_Query = { readonly contentfulBlogPost: Maybe<(
...
type Unnamed_2_Query = { readonly allContentfulBlogPost: { readonly edges: ReadonlyArray<{ readonly node: (
...
type Unnamed_3_Query = { readonly allContentfulBlogPost: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<ContentfulBlogPost, 'title' | 'id' | 'slug'>
        & { readonly eyecatch: Maybe<(
          Pick<ContentfulAsset, 'description'>
          & { readonly fluid: Maybe<GatsbyContentfulFluid_withWebpFragment> }
...
type Unnamed_6_Query = { readonly pattern: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };

type Unnamed_7_QueryVariables = Exact<{ [key: string]: never; }>;


type Unnamed_7_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'lang' | 'description' | 'siteUrl' | 'locale'>> }> };
