...
type cProductgatsbyCafeSitesrctemplatesblogpostTemplateJs3289913226QueryVariables = Exact<{
  id: Scalars['String'];
}>;


type cProductgatsbyCafeSitesrctemplatesblogpostTemplateJs3289913226Query = { readonly contentfulBlogPost: Maybe<(
...
type cProductgatsbyCafeSitesrctemplatescatTemplateJs862777507QueryVariables = Exact<{
...
type cProductgatsbyCafeSitesrctemplatescatTemplateJs862777507Query = { readonly allContentfulBlogPost: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<ContentfulBlogPost, 'title' | 'id' | 'slug'>
        & { readonly eyecatch: Maybe<(
          Pick<ContentfulAsset, 'description'>
          & { readonly fluid: Maybe<GatsbyContentfulFluid_withWebpFragment> }
...
type cProductgatsbyCafeSitesrcpagesaboutTsx303187501QueryVariables = Exact<{ [key: string]: never; }>;
...
type Unnamed_2_Query = { readonly pattern: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };
