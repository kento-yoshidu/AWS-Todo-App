...
type Unnamed_1_Query = { readonly allContentfulBlogPost: { readonly edges: ReadonlyArray<{ readonly node: (
        Pick<ContentfulBlogPost, 'title' | 'id' | 'slug'>
        & { readonly eyecatch: Maybe<(
          Pick<ContentfulAsset, 'description'>
          & { readonly fluid: Maybe<GatsbyContentfulFluid_withWebpFragment> }
...
type Unnamed_2_Query = { readonly about: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment>, readonly original: Maybe<Pick<ImageSharpOriginal, 'height' | 'src' | 'width'>> }> }> };
...
type Unnamed_4_Query = { readonly pattern: Maybe<{ readonly childImageSharp: Maybe<{ readonly fluid: Maybe<GatsbyImageSharpFluid_withWebpFragment> }> }> };
...
type Unnamed_5_Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'lang' | 'description' | 'siteUrl' | 'locale'>> }> };
